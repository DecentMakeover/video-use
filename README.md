...
This fork builds on [`browser-use/video-use`](https://github.com/browser-use/video-use) and adds opinionated creator workflows while preserving the shared media engine.

Drop raw footage in a folder, chat with Claude Code, get `final.mp4` back. Works for any content — talking heads, montages, tutorials, travel, interviews — without presets or menus.

The upstream project can be tried in [Browser Use Cloud](https://cloud.browser-use.com/v4?utm_campaign=video-use-use-in-cloud&utm_source=github). This fork's workflow additions require the local installation below.
...
Video Use keeps one shared media engine and layers editorial judgment through workflow contracts:

- **Street interviews** — foundation workflow for selecting and rendering respondent montages
- **Podcast clips** — candidate handoff plus one approved clip render per run
- **Podcast editing** — handoff-first workflow for long-form cut planning and supported mixed-master rough cuts

The generic workflow still handles other material. See `docs/architecture.md` for capability boundaries and `workflows/` for the individual contracts.
...
```text
Set up https://github.com/DecentMakeover/video-use for me.
...
git clone https://github.com/DecentMakeover/video-use ~/Developer/video-use
...
5. **Production hard rules, artistic freedom elsewhere.** Correctness is non-negotiable. Taste isn't.
